...
1. Setup a virtual cloud network (VCN) called "clinical-trials" in the clinical-trials compartment with the help of VCN wizard as shown below
 ...
 ![setup VCN](images/LAB0-SEC-1.png)
 ![setup VCN](images/LAB0-SEC-2.png)
 ![setup VCN](images/LAB0-SEC-3.png)
 ![setup VCN](images/LAB0-SEC-4.png)
 ![setup VCN](images/LAB0-SEC-5.png)
 ![setup VCN](images/LAB0-SEC-6.png)
 ![setup VCN](images/LAB0-SEC-7.png)
